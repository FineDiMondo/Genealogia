...
> Nota: per evitare errori di caricamento/rendering in alcuni viewer Markdown, le pagine 4–14 sono aggregate in blocchi multi-sheet mantenendo il contenuto ASCII invariato.
